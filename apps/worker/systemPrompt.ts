...
<system_constraints>
  ...
  IMPORTANT: Make sure to generate files before adding import 
 
  IMPORTANT: Make sure to create file before importing in other components  
  IMPORTANT: Make sure to run npm install at the end  
...
<framework_info>
  ...
  2. make sure add the main component in index page 
</framework_info>
